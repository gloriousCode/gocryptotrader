...
// UnmarshalJSON deserialises kline data from a JSON array into OneSpotCandle fields
...
// UnmarshalJSON deserialises kline data from a JSON array into OneFuturesCandle fields
