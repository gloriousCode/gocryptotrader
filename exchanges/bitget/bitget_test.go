...
func TestMain(m *testing.M) {
	...
	if apiKey != "" && apiSecret != "" && clientID != "" {
		...
		e.SetCredentials(&accounts.Credentials{Key: apiKey, Secret: apiSecret, ClientID: clientID})
	}
...
func TestGetFuturesActiveVolume(t *testing.T) {
	...
	expectedData := []ActiveVolumeResp{
		{
			SellVolume: types.NumberFromFloat64(61.87730903),
			BuyVolume:  types.NumberFromFloat64(21.44177026),
			Timestamp:  types.Time(time.UnixMilli(1758601500000)),
		},
		{
			SellVolume: types.NumberFromFloat64(144.01881548),
			BuyVolume:  types.NumberFromFloat64(112.84393002),
			Timestamp:  types.Time(time.UnixMilli(1758601800000)),
		},
		{
			SellVolume: types.NumberFromFloat64(43.49533167),
			BuyVolume:  types.NumberFromFloat64(96.40228133),
			Timestamp:  types.Time(time.UnixMilli(1758602100000)),
		},
		{
			SellVolume: types.NumberFromFloat64(101.4114906),
			BuyVolume:  types.NumberFromFloat64(213.27441876),
			Timestamp:  types.Time(time.UnixMilli(1758602400000)),
		},
		{
			SellVolume: types.NumberFromFloat64(31.2574504),
			BuyVolume:  types.NumberFromFloat64(29.26275559),
			Timestamp:  types.Time(time.UnixMilli(1758602700000)),
		},
		{
			SellVolume: types.NumberFromFloat64(28.17317576),
			BuyVolume:  types.NumberFromFloat64(43.50686056),
			Timestamp:  types.Time(time.UnixMilli(1758603000000)),
		},
		{
			SellVolume: types.NumberFromFloat64(26.3517612),
			BuyVolume:  types.NumberFromFloat64(21.58492462),
...
func TestGetFuturesPositionRatios(t *testing.T) {
	...
	expectedData := []PosRatFutureResp{
		{
			LongPositionRatio:      types.NumberFromFloat64(0.5061),
			ShortPositionRatio:     types.NumberFromFloat64(0.4939),
			LongShortPositionRatio: types.NumberFromFloat64(0.0102),
			Timestamp:              types.Time(time.UnixMilli(1758602400000)),
		},
		{
			LongPositionRatio:      types.NumberFromFloat64(0.5058),
			ShortPositionRatio:     types.NumberFromFloat64(0.4942),
			LongShortPositionRatio: types.NumberFromFloat64(0.0102),
			Timestamp:              types.Time(time.UnixMilli(1758602700000)),
		},
		{
		...
		{
			LongPositionRatio:      types.NumberFromFloat64(0.5055),
			ShortPositionRatio:     types.NumberFromFloat64(0.4945),
			LongShortPositionRatio: types.NumberFromFloat64(0.0102),
			Timestamp:              types.Time(time.UnixMilli(1758603300000)),
		},
	}
...
func TestGetFuturesRatios(t *testing.T) {
	...
	expectedData := []RatioResp{
		{
			LongRatio:      types.NumberFromFloat64(0.7743),
			ShortRatio:     types.NumberFromFloat64(0.2257),
			LongShortRatio: types.NumberFromFloat64(0.0343),
			Timestamp:      types.Time(time.UnixMilli(1758602700000)),
		},
		{
			LongRatio:      types.NumberFromFloat64(0.7743),
		...
		{
			LongRatio:      types.NumberFromFloat64(0.7753),
			ShortRatio:     types.NumberFromFloat64(0.2247),
			LongShortRatio: types.NumberFromFloat64(0.0345),
			Timestamp:      types.Time(time.UnixMilli(1758603300000)),
		},
		{
			LongRatio:      types.NumberFromFloat64(0.7753),
...
func TestGetFuturesAccountRatios(t *testing.T) {
	...
	expectedData := []AccountRatioResp{
		{
			LongAccountRatio:      types.NumberFromFloat64(0.7724),
			ShortAccountRatio:     types.NumberFromFloat64(0.2276),
			LongShortAccountRatio: types.NumberFromFloat64(0.0339),
			Timestamp:             types.Time(time.UnixMilli(1758603000000)),
		},
		{
			LongAccountRatio:      types.NumberFromFloat64(0.7734),
			ShortAccountRatio:     types.NumberFromFloat64(0.2266),
			LongShortAccountRatio: types.NumberFromFloat64(0.0341),
			Timestamp:             types.Time(time.UnixMilli(1758603300000)),
		},
		{
			LongAccountRatio:      types.NumberFromFloat64(0.7735),
			ShortAccountRatio:     types.NumberFromFloat64(0.2265),
			LongShortAccountRatio: types.NumberFromFloat64(0.0341),
			Timestamp:             types.Time(time.UnixMilli(1758603600000)),
		},
		{
			LongAccountRatio:      types.NumberFromFloat64(0.7737),
			ShortAccountRatio:     types.NumberFromFloat64(0.2263),
			LongShortAccountRatio: types.NumberFromFloat64(0.0341),
...
func TestBatchCancelAndPlaceSpotOrders(t *testing.T) {
	...
	req = append(req, ReplaceSpotOrderParams{
		...
		Price:            types.NumberFromFloat64(testPrice),
		Amount:           types.NumberFromFloat64(testAmount),
		Pair:             newPair,
	})
	_, err = e.BatchCancelAndPlaceSpotOrders(t.Context(), req)
	assert.NoError(t, err)
...
func TestBatchPlaceSpotOrders(t *testing.T) {
	...
	req = append(req, PlaceSpotOrderParams{
		...
		Strategy:  "IOC",
		Price:     types.NumberFromFloat64(testPrice),
		Size:      types.NumberFromFloat64(testAmount),
		Pair:      testPair,
	})
...
func TestBatchPlaceCrossOrders(t *testing.T) {
	...
	orders := []MarginOrderData{
		{
			BaseAmount: types.NumberFromFloat64(testAmount2),
			Price:      types.NumberFromFloat64(testPrice2),
			OrderType:  order.Limit.Lower(),
			Strategy:   "GTC",
			LoanType:   "normal",
			Side:       "Buy",
