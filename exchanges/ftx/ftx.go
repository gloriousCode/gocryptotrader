...
func (f *FTX) LoadCollateralWeightings(ctx context.Context) error {
	...
	f.collateralWeight.store("1INCH", 0.9, 0.85, 0.0005)
	f.collateralWeight.store("AAPL", 0.9, 0.85, 0.005)
	f.collateralWeight.store("AAVE", 0.9, 0.85, 0.0025)
	f.collateralWeight.store("ABNB", 0.9, 0.85, 0.005)
	f.collateralWeight.store("ACB", 0.9, 0.85, 0.0025)
	f.collateralWeight.store("ALPHA", 0.9, 0.85, 0.00025)
	f.collateralWeight.store("AMC", 0.9, 0.85, 0.0025)
	f.collateralWeight.store("AMD", 0.9, 0.85, 0.005)
	f.collateralWeight.store("AMZN", 0.9, 0.85, 0.03)
	f.collateralWeight.store("APHA", 0.9, 0.85, 0.001)
	f.collateralWeight.store("ARKK", 0.9, 0.85, 0.005)
	f.collateralWeight.store("AUD", 0.99, 0.98, 0.00001)
	f.collateralWeight.store("BABA", 0.9, 0.85, 0.01)
	f.collateralWeight.store("BADGER", 0.85, 0.8, 0.0025)
	f.collateralWeight.store("BAND", 0.85, 0.8, 0.001)
	f.collateralWeight.store("BAO", 0.85, 0.8, 0.000025)
	f.collateralWeight.store("BB", 0.9, 0.85, 0.0025)
	f.collateralWeight.store("BCH", 0.95, 0.9, 0.0008)
	f.collateralWeight.store("BILI", 0.9, 0.85, 0.005)
	f.collateralWeight.store("BITW", 0.9, 0.85, 0.005)
	f.collateralWeight.store("BNB", 0.95, 0.9, 0.0005)
	f.collateralWeight.store("BNT", 0.9, 0.85, 0.0025)
	f.collateralWeight.store("BNTX", 0.9, 0.85, 0.005)
	f.collateralWeight.store("BRL", 0.99, 0.98, 0.00001)
	f.collateralWeight.store("BRZ", 0.99, 0.98, 0.00001)
	f.collateralWeight.store("BTC", 0.975, 0.95, 0.002)
	f.collateralWeight.store("BTMX", 0.7, 0.65, 0.0008)
	f.collateralWeight.store("BUSD", 1, 1, 0)
	f.collateralWeight.store("BVOL", 0.85, 0.8, 0.005)
	f.collateralWeight.store("BYND", 0.9, 0.85, 0.0075)
	f.collateralWeight.store("CAD", 0.99, 0.98, 0.00001)
	f.collateralWeight.store("CEL", 0.85, 0.8, 0.001)
	f.collateralWeight.store("CGC", 0.9, 0.85, 0.0025)
	f.collateralWeight.store("CHF", 0.99, 0.98, 0.00001)
	f.collateralWeight.store("COIN", 0.85, 0.8, 0.01)
	f.collateralWeight.store("COMP", 0.9, 0.85, 0.002)
	f.collateralWeight.store("COPE", 0.6, 0.55, 0.02)
	f.collateralWeight.store("CRON", 0.9, 0.85, 0.001)
	f.collateralWeight.store("CUSDT", 0.9, 0.85, 0.00001)
	f.collateralWeight.store("DAI", 0.9, 0.85, 0.00005)
	f.collateralWeight.store("DOGE", 0.95, 0.9, 0.00002)
	f.collateralWeight.store("ETH", 0.95, 0.9, 0.0004)
	f.collateralWeight.store("STETH", 0.9, 0.85, 0.0012)
	f.collateralWeight.store("ETHE", 0.9, 0.85, 0.0025)
	f.collateralWeight.store("EUR", 0.99, 0.98, 0.00001)
	f.collateralWeight.store("FB", 0.9, 0.85, 0.01)
	f.collateralWeight.store("FIDA", 0.85, 0.8, 0.001)
	f.collateralWeight.store("FTM", 0.85, 0.8, 0.0005)
	f.collateralWeight.store("FTT", 0.95, 0.95, 0.0005)
	f.collateralWeight.store("GBP", 0.99, 0.98, 0.00001)
	f.collateralWeight.store("GBTC", 0.9, 0.85, 0.0025)
	f.collateralWeight.store("GDX", 0.9, 0.85, 0.0025)
	f.collateralWeight.store("GDXJ", 0.9, 0.85, 0.005)
	f.collateralWeight.store("GLD", 0.9, 0.85, 0.005)
	f.collateralWeight.store("GLXY", 0.9, 0.85, 0.005)
	f.collateralWeight.store("GME", 0.9, 0.85, 0.005)
	f.collateralWeight.store("GOOGL", 0.9, 0.85, 0.025)
	f.collateralWeight.store("GRT", 0.9, 0.85, 0.00025)
	f.collateralWeight.store("HKD", 0.99, 0.98, 0.00001)
	f.collateralWeight.store("HOLY", 0.9, 0.85, 0.0005)
	f.collateralWeight.store("HOOD", 0.85, 0.8, 0.005)
	f.collateralWeight.store("HT", 0.9, 0.85, 0.0003)
	f.collateralWeight.store("HUSD", 1, 1, 0)
	f.collateralWeight.store("HXRO", 0.85, 0.8, 0.001)
	f.collateralWeight.store("IBVOL", 0.85, 0.8, 0.015)
	f.collateralWeight.store("KIN", 0.85, 0.8, 0.000008)
	f.collateralWeight.store("KNC", 0.95, 0.9, 0.001)
	f.collateralWeight.store("LEO", 0.85, 0.8, 0.001)
	f.collateralWeight.store("LINK", 0.95, 0.9, 0.0004)
	f.collateralWeight.store("LRC", 0.85, 0.8, 0.0005)
	f.collateralWeight.store("LTC", 0.95, 0.9, 0.0004)
	f.collateralWeight.store("MATIC", 0.85, 0.8, 0.00004)
	f.collateralWeight.store("MKR", 0.9, 0.85, 0.007)
	f.collateralWeight.store("MOB", 0.6, 0.55, 0.005)
	f.collateralWeight.store("MRNA", 0.9, 0.85, 0.005)
	f.collateralWeight.store("MSTR", 0.9, 0.85, 0.008)
	f.collateralWeight.store("NFLX", 0.9, 0.85, 0.01)
	f.collateralWeight.store("NIO", 0.9, 0.85, 0.004)
	f.collateralWeight.store("NOK", 0.9, 0.85, 0.001)
	f.collateralWeight.store("NVDA", 0.9, 0.85, 0.01)
	f.collateralWeight.store("OKB", 0.9, 0.85, 0.0003)
	f.collateralWeight.store("OMG", 0.85, 0.8, 0.001)
	f.collateralWeight.store("USDP", 1, 1, 0)
	f.collateralWeight.store("PAXG", 0.95, 0.9, 0.002)
	f.collateralWeight.store("PENN", 0.9, 0.85, 0.005)
	f.collateralWeight.store("PFE", 0.9, 0.85, 0.004)
	f.collateralWeight.store("PYPL", 0.9, 0.85, 0.008)
	f.collateralWeight.store("RAY", 0.85, 0.8, 0.0005)
	f.collateralWeight.store("REN", 0.9, 0.85, 0.00025)
	f.collateralWeight.store("RSR", 0.85, 0.8, 0.0001)
	f.collateralWeight.store("RUNE", 0.85, 0.8, 0.001)
	f.collateralWeight.store("SECO", 0.9, 0.85, 0.0005)
	f.collateralWeight.store("SGD", 0.99, 0.98, 0.00001)
	f.collateralWeight.store("SLV", 0.9, 0.85, 0.0025)
	f.collateralWeight.store("SNX", 0.85, 0.8, 0.001)
	f.collateralWeight.store("SOL", 0.9, 0.85, 0.0004)
	f.collateralWeight.store("STSOL", 0.9, 0.85, 0.0004)
	f.collateralWeight.store("MSOL", 0.9, 0.85, 0.0004)
	f.collateralWeight.store("SPY", 0.9, 0.85, 0.01)
	f.collateralWeight.store("SQ", 0.9, 0.85, 0.008)
	f.collateralWeight.store("SRM", 0.9, 0.85, 0.0005)
	f.collateralWeight.store("SUSHI", 0.95, 0.9, 0.001)
	f.collateralWeight.store("SXP", 0.9, 0.85, 0.0005)
	f.collateralWeight.store("TLRY", 0.9, 0.85, 0.001)
	f.collateralWeight.store("TOMO", 0.85, 0.8, 0.0005)
	f.collateralWeight.store("TRX", 0.9, 0.85, 0.00001)
	f.collateralWeight.store("TRY", 0.99, 0.98, 0.00001)
	f.collateralWeight.store("TRYB", 0.9, 0.85, 0.00001)
	f.collateralWeight.store("TSLA", 0.9, 0.85, 0.01)
	f.collateralWeight.store("TSM", 0.9, 0.85, 0.015)
	f.collateralWeight.store("TUSD", 1, 1, 0)
	f.collateralWeight.store("TWTR", 0.9, 0.85, 0.004)
	f.collateralWeight.store("UBER", 0.9, 0.85, 0.004)
	f.collateralWeight.store("UNI", 0.95, 0.9, 0.001)
	f.collateralWeight.store("USD", 1, 1, 0)
	f.collateralWeight.store("USDC", 1, 1, 0)
	f.collateralWeight.store("USDT", 0.975, 0.95, 0.00001)
	f.collateralWeight.store("USO", 0.9, 0.85, 0.0025)
	f.collateralWeight.store("WBTC", 0.975, 0.95, 0.005)
	f.collateralWeight.store("WUSDC", 1, 1, 0)
	f.collateralWeight.store("WUSDT", 0.975, 0.95, 0.00001)
	f.collateralWeight.store("XAUT", 0.95, 0.9, 0.002)
	f.collateralWeight.store("XRP", 0.95, 0.9, 0.00002)
	f.collateralWeight.store("YFI", 0.9, 0.85, 0.015)
	f.collateralWeight.store("ZAR", 0.99, 0.98, 0.00001)
	f.collateralWeight.store("ZM", 0.9, 0.85, 0.01)
	f.collateralWeight.store("ZRX", 0.85, 0.8, 0.001)
	...
	for i := range coins {
		...
		f.collateralWeight.storeTotal(coins[i].ID, coins[i].CollateralWeight)
	}
	...
	for i := range futures {
		f.collateralWeight.storeInitialMarginFraction(futures[i].Underlying, futures[i].InitialMarginFractionFactor)
	}
...
func (c CollateralWeightHolder) storeTotal(code string, weighting float64) {
	cc := currency.NewCode(code)
	currencyCollateral := c[cc.Item]
	currencyCollateral.MaintenancePosition = weighting
	c[cc.Item] = currencyCollateral
}

func (c CollateralWeightHolder) storeInitialMarginFraction(code string, imf float64) {
	cc := currency.NewCode(code)
	currencyCollateral := c[cc.Item]
...
func (c CollateralWeightHolder) store(code string, total, initial, imfFactor float64) {
	cc := currency.NewCode(code)
	c[cc.Item] = CollateralWeight{
		MaintenancePosition:         total,
		OpeningPosition:             initial,
