...
var defaultSubscriptions = subscription.List{
	...
	{Enabled: false, Channel: subscription.CandlesChannel, Asset: asset.Spot, Interval: kline.FiveMin},
	{Enabled: true, Channel: subscription.OrderbookChannel, Asset: asset.Spot, Interval: kline.HundredMilliseconds},
	{Enabled: false, Channel: spotBalancesChannel, Asset: asset.Spot, Authenticated: true},
	{Enabled: false, Channel: crossMarginBalanceChannel, Asset: asset.CrossMargin, Authenticated: true},
	{Enabled: false, Channel: marginBalancesChannel, Asset: asset.Margin, Authenticated: true},
