...
type FuturesPositionMode uint32

const (
	// FuturesPositionModeUnknown indicates that position mode has not been loaded.
...
type SpotOrderParam struct {
	...
	VisibleSize         float64       `json:"visibleSize,omitempty,string"` // The maximum visible size of a spot iceberg order
}
