...
const file_rpc_proto_rawDesc = "" +
	...
	"\x13used_in_spot_margin\x18\b \x01(\tR\x10usedInSpotMargin\"\xba\x02\n" +
	...
	"\x05rates\x18\x01 \x01(\v2\x13.gctrpc.FundingDataR\x05rates\"y\n" +
	"\x1bGetLatestFundingRateRequest\x12\x1a\n" +
	"\bexchange\x18\x01 \x01(\tR\bexchange\x12\x14\n" +
	"\x05asset\x18\x02 \x01(\tR\x05asset\x12(\n" +
	"\x04pair\x18\x03 \x01(\v2\x14.gctrpc.CurrencyPairR\x04pair\"G\n" +
